...
class Database
{
  ...
  function select($field,$table,$condField,$condValue){
    ...
    //select values from table with condition applied
    if($result = $dbobj -> query("SELECT ".$field." FROM ".$table." WHERE ".$condField."=".$condValue)) {
